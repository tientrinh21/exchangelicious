      ...
      <div className="block text-left"> {}
        <div className="max-w-full mx-auto p-4 bg-white flex justify-between items-center hover:bg-gray-100 transition-colors duration-150 rounded-lg cursor-pointer">
          ...
          <div>
            ...
            <p className="text-muted-foreground font-semibold">Seoul, South Korea | Suwon Campus | F2 Visa</p>
          </div>

          {/* Right Section */}
          <div className="text-right">
            <p className="text-muted-foreground font-semibold">QS Ranking: 115</p>
            <p className="text-muted-foreground font-semibold">Dormitory: Available</p>
          </div>
        </div>
      </div>
    </Link>
