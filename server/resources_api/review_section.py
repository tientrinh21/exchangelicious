...
class ReviewRes(Resource):
    def __init__(self) -> None:
        ...
        self.review_get_args.add_argument('review_id', type=str, location = "args", required=True, help='ID of the review to be fetched')

        self.review_put_args = reqparse.RequestParser()
        self.review_put_args.add_argument('user_id', type=str, location = "json", help='The user ID of the author of the review', required=True)
        self.review_put_args.add_argument('university_id', type=str, location = "json", help='The ID of the university to review', required=True)
        self.review_put_args.add_argument('title', type=str, location = "json", help='The title of the review', required=True)
        self.review_put_args.add_argument('content', type=str, location = "json", help='The text/content of the review', required=True)
        self.review_put_args.add_argument('mood_score', type=str, location = "json", help='The mood score of the review. Should be one of the enum values', required=True)

        self.review_update_args = reqparse.RequestParser()
        self.review_update_args.add_argument('review_id', type=str, location = "args", required=True, help='ID of the review to be updated')
        self.review_update_args.add_argument('title', type=str, location = "json", help='The title of the review')
        self.review_update_args.add_argument('content', type=str, location = "json", help='The text/content of the review')
        self.review_update_args.add_argument('mood_score', type=str, location = "json", help='The mood score of the review. Should be one of the enum values')

        self.review_delete_args = reqparse.RequestParser()
        self.review_delete_args.add_argument('review_id', type=str, location = "args", required=True, help='ID of the review to be deleted')
