...
class UniversityWithInfoRes(Resource):
    ...
    def get(self, university_id):
        ...
        # stmt = select(UniversityTable, InfoPageTable).select_from(UniversityTable).join(InfoPageTable, UniversityTable.info_page_id == InfoPageTable.info_page_id).where(UniversityTable.university_id == university_id)
