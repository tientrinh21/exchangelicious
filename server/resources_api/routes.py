from resources_api.users import UserRes, UsersAllRes, UserWithUniversityRes, UserLoginRes
from resources_api.universities import UniversityPaginationRes, UniversityRes,  UniversityWithInfoRes, UniversityAllRes
