...
def insert_info_into_mysql(filename, url, headings):
    ...
    try:
        ...
        add_info = ("INSERT INTO info_page_table (info_page_id, webpage, introduction, location, semester, application_deadlines, courses, expenses, housing, visa, eligibility, requirements) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)")
